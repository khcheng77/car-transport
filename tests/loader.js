/* ============================================================
   ...
   將 js/ 下的模組（data / loadengine / moduleA/B/C/D）載入乾淨的
...
const FILES = ['data.js', 'loadengine.js', 'moduleA.js', 'moduleB.js', 'moduleC.js', 'moduleD.js'];

/* 回傳一個全新載入的 context（含 DB / 引擎 / 四模組單例）*/
function fresh() {
  ...
  src += '\n; ({ DB, WasteFactorProvider, checkLoad, effectiveLoad, itemEffective,'
       + ' ModuleA, ModuleB, ModuleC, ModuleD, fmtVol, minToHHMM, hhmmToMin });';
